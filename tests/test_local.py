...
"""
Prueba tu agente Printealito sin necesitar WhatsApp.
Simula una conversación en la terminal como si fueras un cliente de Printealo.
"""
...
async def main():
    ...
    print()
    print("=" * 55)
    print("   Printealito — Test Local (Printealo)")
    print("=" * 55)
    print()
